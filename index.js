...
document.getElementById('city-form').addEventListener('submit', function(event) {
    ...
    document.getElementById('weather-container').appendChild(loadingMessage);
    ...
    fetch(`https://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=${cityName}&days=7`)
        ...
        .then(data => {
            ...
            // Удаляем сообщение "Loading..."
            document.getElementById('weather-container').removeChild(loadingMessage);
